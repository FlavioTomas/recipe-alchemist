                ...
                {recipes.map(recipe => (
                    ...
                    >
                        ...
                        <div className="relative h-48 overflow-hidden">
                            <img src={recipe.image.replace('312x312', '636x393')}
                                alt={recipe.title}
                                className="w-full max-w-300 h-full object-cover group-hover:scale-110 transition-transform duration-500"
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-transparent to-tranparent opacity-80 " />
                        </div>

                        <div className="p-5">
                            <h3 className="text-xl font-bold text-slte-100 mb-2 line-clamp-2">
                                {recipe.title}
                            </h3>
